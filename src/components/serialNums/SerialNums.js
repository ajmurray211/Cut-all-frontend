...
const SerialNums = (props) => {
    ...
    return (
        ...
        //     </section>
        // </div >
        <div className='serialNumPage'>
            <section className='serialNumTitleSection'>
                <div className='serialNumberListSection'></div>
                <div className='SerialNumButtonContainer'></div>
            </section>
            <section className='serialNumDataSection'>
                <div  className='SerialNumMetaContainer'></div>
                <div className='SerialNumGraph1'></div>
                <div className='SerialNumGraph2'></div>
                <div></div>
            </section>
            <section className='serialNumDistributorSection'>
                <div></div>
                <div className='distributorMeta'></div>
                <div className='SerialNumGraph3'></div>
            </section>
        </div>
    );
}
